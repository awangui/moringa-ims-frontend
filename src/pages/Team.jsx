...
const Team = () => {
    ...
    const handleManagePermissions = (member) => {
        navigate('/users', { state: { userId: member.id } }); // Pass the member ID
    };
                        ...
                        {filteredMembers.map((member) => (
                            <tr key={member.id} className="hover:bg-gray-100">
                                ...
                                <td className="border-b border-gray-300 p-2">
                                    ...
                                    <button className="text-blue-500" onClick={() => handleManagePermissions(member)}>
                                        Manage Permissions
                                    </button>
                                </td>
                            </tr>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                        <div className="bg-white p-6 rounded shadow-lg w-96">
                            ...
                            <div className="flex justify-end">
                                ...
                                <button className="bg-orange-500 text-white px-4 py-2 rounded" onClick={() => setShowDeleteModal(false)}>
                                    Cancel
                                </button>
                            </div>
                        </div>
...
export default Team; // Ensure only this export is present